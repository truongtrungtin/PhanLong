...
$(function () {
    $("#dataTable").DataTable({ "responsive": true, "sort": false, "autoWidth": false, "scrollX": false, });
    ...
    $("#kehoach").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } });
    $("#chitiet").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } });
    $("#phieuchi").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } });
    $("#phieuthu").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } });
    $("#update").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } });
    $("#delete").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (!confirm("Bạn có chắc chắn muốn xóa không?")) { return false; } } else { alert("Không có giá trị nào được chọn để xóa!!"); return false; } });
    $("#themngayguibai").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } });
    $("#themngaygiao").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } });
    $("#giahanluubai").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } });
    $("#giahanluucont").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } });
    $("#giahanluurong").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } });
...
var EditTodoList = function (Id) {
    var url = "/Home/EditTodoList/" + Id;
    $("#myModalEditTodoList").load(url, function () {
        $("#MyModalEditTodoList").modal();
    });
};



var AddFilesCTBill = function (Id) {
    var url = "/DanhMuc/DMBill/AddFilesCTBill?id=" + Id;
    $("#myModalBodyDiv").load(url, function () {
        $("#MyModal").modal();
    });
};

var EditGhiChuChiPhi = function (Id) {
    var url = "/ThongKe/Luong/EditGhiChuChiPhi?id=" + Id;
    $("#myModalBodyDivPhi").load(url, function () {
        $("#MyModalPhi").modal();
    });
};


var EditGhiChuChiHo = function (Id) {
    var url = "/ThongKe/Luong/EditGhiChuChiHo?id=" + Id;
    $("#myModalBodyDiv").load(url, function () {
        $("#MyModal").modal();
    });
};

var EditGhiChuThanhToan = function (Id) {
    var url = "/ThongKe/ChiTiet/EditGhiChuThanhToan?id=" + Id;
    $("#myModalBodyDiv").load(url, function () {
        $("#MyModal").modal();
    });
};
...
var ThanhToanHoaDon = function (Id,ngaythanhtoan) {
    var url = "/ThongKe/HoaDon/ThanhToanHoaDon?id=" + Id + "&ngaythanhtoan=" + ngaythanhtoan;
    $("#myModalBodyDivHoaDon").load(url, function () {
        $("#MyModalHoaDon").modal();
    });
};
...
$("#SaveGhiChu").click(function () {
    ...
    $.ajax({
        type: "Post", url: "/Luong/SaveDataInDatabase",
        data: mydata, success: function (result) {
...
//$("#Cont").removeClass("select2");
//$("#Cont").hide();

$("#SaveGhiChuchi").click(function () {
    var mydata = $("#SubmitForm").serialize(); $.ajax({
        type: "Post", url: "/Luong/SaveDataInDatabase", data: mydata, success: function (result) {
            alert("Thêm ghi chú thành công!");
            $("#MyModalPhi").modal("hide");
        }
    })
});
...
//    var mydata = $("#SubmitForm").serialize();
//    $.ajax({
//        type: "Post", url: "/HoaDon/SaveDataInDatabase",
//        data: mydata, success: function (result) {
//            alert("Thêm thành công!");
//            $("#MyModalHoaDon").modal("hide");
//        }
//    });
//});
