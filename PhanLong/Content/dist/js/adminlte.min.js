...
$(function () {
    $("#dataTable").DataTable({ "responsive": true, "sort": false, "autoWidth": false, "scrollX": false, }); $('#toast-container').removeClass('hide'); $('#toast-container').delay(3000).slideUp(500); $('.select2').select2({ theme: 'bootstrap4', allowClear: true }); $('#datemask').inputmask('dd/mm/yyyy', { 'placeholder': 'dd/mm/yyyy' })
    $('[data-mask]').inputmask()
    $('#reservation').on('apply.daterangepicker', function (ev, picker) { $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY')); }); $('#reservation').on('cancel.daterangepicker', function (ev, picker) { $(this).val(''); }); bsCustomFileInput.init(); $("#kehoach").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } }); $("#chitiet").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } }); $("#phieuchi").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } }); $("#phieuthu").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } }); $("#update").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } }); $("#delete").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (!confirm("Bạn có chắc chắn muốn xóa không?")) { return false; } } else { alert("Không có giá trị nào được chọn để xóa!!"); return false; } }); $("#themngayguibai").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } }); $("#themngaygiao").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } });
}); var EditGhiChu = function (Id) { var url = "/ThongKe/Luong/EditGhiChu?id=" + Id; $("#myModalBodyDiv").load(url, function () { $("#MyModal").modal(); }) }
$("#SaveGhiChu").click(function () { var mydata = $("#SubmitForm").serialize(); $.ajax({ type: "Post", url: "/Luong/SaveDataInDatabase", data: mydata, success: function (result) { alert("Thêm ghi chú thành công!"); $("#MyModal").modal("hide"); } }) })
document.getElementById("check").onclick = function () { var checkboxes = document.getElementsByName('chkId[]'); if (document.getElementById("check").checked) { for (var i = 0; i < checkboxes.length; i++) { checkboxes[i].checked = true; } } else { for (var i = 0; i < checkboxes.length; i++) { checkboxes[i].checked = false; } } };
