...
$(function () {
    ...
    $("#kehoach").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } }); $("#chitiet").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } });
    $("#phieuchi").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } }); $("#phieuthu").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { if (checkboxes < 2) { return true; } else { alert("Chỉ chọn một giá trị!"); return false; } } else { alert("Không có giá trị nào được chọn!!"); return false; } });
    ...
    $("#themngayguibai").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } }); $("#themngaygiao").click(function () { var checkboxes = document.querySelectorAll('input[name="chkId[]"]:checked').length; if (checkboxes > 0) { return true; } else { alert("không có cont nào được chọn!!"); return false; } });
